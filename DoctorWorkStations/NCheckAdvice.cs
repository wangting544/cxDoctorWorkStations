...
{
    public partial class NCheckAdvice : Form
    {
        public NCheckAdvice()
        {
            InitializeComponent();
        ...
        private void Search()
        {
            ...
            sqlCommand.CommandText = $@"select 
	                                   ...
	                                   from tb_PatientAdvice as pa
                                            ...
                                            where PatientNo='{cb_inHosptial.SelectedValue}' and pa.isexecute is null";
        ...
        private void IsInHosptial()
        {
            ...
            sqlDataAdapter.Fill(dataTable);
            sqlConnection.Close();
            cb_inHosptial.DataSource=dataTable ;
            cb_inHosptial.DisplayMember = "Name";
            cb_inHosptial.ValueMember = "No";
        }
        ...
        private void NCheckAdvice_FormClosed(object sender, FormClosedEventArgs e)
        {
